...
<div class="block-header">
    ...
    <div class="alert alert-primary my-4 rounded" role="alert">
        <div class="d-flex align-items-center">
            ...
            Terbitkan ulasan agar Mahasiswa dapat membaca atau menonton materi yang diberikan.
        </div>
    </div>
    ...
    <div class="bg-white mt-3 px-3 py-4 text-dark">
        <form>
            ...
            <div class="form-group mb-3">
                ...
                <input type="number" min="0" max="100" class="form-control" id="exp" placeholder="Masukkan poin untuk mahasiswa" name="activity_exp">
            </div>
