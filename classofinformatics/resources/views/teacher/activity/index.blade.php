...
<div class="block-header">
    ...
    <div class="alert alert-primary my-4 rounded" role="alert">
        <div class="d-flex align-items-center">
            ...
            Terbitkan {{$activity['type'] === 'EXAM' ? 'ulangan' : 'latihan'}} agar mahasiswa dapat mengerjakan {{$activity['type'] === 'EXAM' ? 'ulangan' : 'latihan'}} yang dibagikan
        </div>
    </div>
    ...
    <div class="bg-white mt-3 px-3 py-4 text-dark">
        <form>
            ...
            <div class="form-group mb-3">
                ...
                <input type="number" min="0" max="100" class="form-control" id="exp" placeholder="Masukkan poin untuk Mahasiswa" name="activity_exp" value="{{ $activity['experience'] }}">
            </div>
            <div class="mb-4">
