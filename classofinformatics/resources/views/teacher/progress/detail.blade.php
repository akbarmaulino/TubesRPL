    ...
    <div class="row clearfix mb-4">
        <div class="col-md-6 col-sm-12">
            ...
            <nav aria-label="breadcrumb" class="mt-2">
                ...
                <li class="breadcrumb-item active" aria-current="page">Progress Mahasiswa</li>
                </ol>
            </nav>
        </div>
    </div>
        <div class="row mt-3">
            <div class="col-lg-12">
            <h5 class="color-blue-2 font-weight-bold text-uppercase">Progress Mahasiswa Bab {{$topic['name']}}</h5>
            <div class="card">
