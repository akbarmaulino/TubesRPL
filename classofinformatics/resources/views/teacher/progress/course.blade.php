    ...
    <div class="row clearfix mb-4">
        <div class="col-md-6 col-sm-12">
            ...
            <nav aria-label="breadcrumb" class="mt-4">
                <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('teacher.progress-siswa') }}">Progress Mahasiswa</a></li>
...
<script text="text/javascript">
    ...
    function getCourseTopic() {
        url = "{{ url('/progress/subject/course/topic') }}"
        ...
        let html = ``
            ...
            <div class="row-clearfix mt-5">
                ...
                $.each(data.data, function (key, topic) { 
                    html += `
                    <div class="mt-3">
                        <a href="{{ url('progress/subject/${subject.id}/course/${course.id}/topic/${topic.id}') }}" class="d-flex align-items-center p-2 w-100 bg-white shadow-sm rounded border-hover">
