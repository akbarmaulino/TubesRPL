    ...
    <div class="clearfix mb-3">
        ...
        @if (request()->route('role') === "STUDENT")
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">class of informatics</a></li>
                    <li class="breadcrumb-item active">Kelola Akun</li>
                    <li class="breadcrumb-item active" aria-current="page">Akun Mahasiswa</li>
                </ol>
            </nav>
            <h1 class="color-blue-2 font-weight-bold my-4" style="font-size: 1.8rem;">Akun Mahasiswa</h1>
        @endif
        @if (request()->route('role') === "TEACHER")
            <nav aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{route('dashboard')}}">class of informatics</a></li>
                    <li class="breadcrumb-item active">Kelola Akun</li>
                    <li class="breadcrumb-item active" aria-current="page">Akun Mentor</li>
                </ol>
            </nav>
            <h1 class="color-blue-2 font-weight-bold my-4" style="font-size: 1.8rem;">Akun Mentor</h1>
        @endif
