...
<head>
    <title>Masuk - class of informatics </title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">

    <link rel="icon" href="{{asset('assets/images/logo-graduation.jpg')}}" type="image/x-icon">
    <!-- VENDOR CSS -->
        ...
        <div class="auth_div vivify fadeInTop">
            <div class="card">
                <div class="body justify-content-around">
                    <div class="login-img">
                        <img src="{{asset('assets/images/logo-graduation.jpg')}}" height="400" width="450">
                    </div>
                    <form class="form-auth-small my-auto" action="{{route('auth')}}" method="post">
                        <p class="text-center" style="font-family:cursive; font-size: 25px;">Class Of Informatics</p>
                        {{ csrf_field() }}
