...
<li class="{{ Request::is('statistik/*') ? 'active' : '' }} open">
    ...
    <ul>
        ...
        <li class="{{ Request::is('statistik/accounts/STUDENT') ? 'active' : '' }}"><a href="{{ route('admin.statistik.accounts', ['role' => "STUDENT"]) }}">Akun Mahasiswa</a></li>
        <li class="{{ Request::is('statistik/accounts/TEACHER') ? 'active' : '' }}"><a href="{{ route('admin.statistik.accounts', ['role' => "TEACHER"]) }}">Akun Mentor</a></li>
