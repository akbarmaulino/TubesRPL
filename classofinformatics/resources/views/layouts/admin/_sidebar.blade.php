...
<li class="{{ Request::is('admin/statistik/accounts/*') ? 'active open' : '' }}">
    ...
    <ul>
        ...
        <li class="{{ Request::is('admin/statistik/accounts/STUDENT') ? 'active open' : '' }}"><a href="{{ route('admin.statistik.accounts', ['role' => "STUDENT"]) }}">Akun Mahasiswa</a></li>
        <li class="{{ Request::is('admin/statistik/accounts/TEACHER') ? 'active open' : '' }}"><a href="{{ route('admin.statistik.accounts', ['role' => "TEACHER"]) }}">Akun Mentor</a></li>
