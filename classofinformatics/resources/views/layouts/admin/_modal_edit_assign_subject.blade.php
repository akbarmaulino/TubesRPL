    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white" id="exampleModalLabel">Edit Mentor Mapel</h5>
            ...
            <div class="modal-body">
                ...
                <div class="d-flex flex-wrap mt-2">
                    <a href="#" id="addTeacherInput" onclick="addInput('newSelectInModal','teacher-field-modal')">+ Tambah Mentor</a>
                    <a href="#" id="reduceTeacherInput" class="text-danger ml-3" onclick="reduceInput('teacher-field-modal')">- Kurangi Input Mentor</a>
                </div>
            </div>
